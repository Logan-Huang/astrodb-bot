...
A GitHub Action (`.github/workflows/sync-version.yml`) automatically updates `pyproject.toml` to match the tag when a release is published — you do not need to bump the version manually.
